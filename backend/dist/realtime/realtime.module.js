...
exports.RealtimeModule = RealtimeModule = __decorate([
    (0, common_1.Module)({
        providers: [realtime_gateway_1.RealtimeGateway, sessions_service_1.SessionsService],
        exports: [realtime_gateway_1.RealtimeGateway, sessions_service_1.SessionsService],
    })
], RealtimeModule);
